...
$text1 = "Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.";
$text2 = "Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.";
$text3 = "Lorem ipsum dolor sit amet, consectetur adipisicing elit.";

$work = [
    [
        "name" => "Front End Developer", 
        "date of the beginning" => "Jan 2015", 
        "date of completion" => "<span class='w3-tag w3-teal w3-round'>Current</span>", 
        "text" => $text1
    ],
    [
        "name" => "Web Developer / something.com", 
        "date of the beginning" => "Mar 2012", 
        "date of completion" => "Dec 2014", 
        "text" => $text2
    ],
    [
        "name" => "Graphic Designer / designsomething.com", 
        "date of the beginning" => "Jun 2010", 
        "date of completion" => "Mar 2012", 
        "text" => $text3
    ]
];
?>
